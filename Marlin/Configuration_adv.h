...
#define EXTRUDER_AUTO_FAN_SPEED   204  // == full speed
 ...
 */
  ...
  #define PROBING_MARGIN_RIGHT 185
  #define PROBING_MARGIN_FRONT 62
 ...
 */
  ...
  #define X_CURRENT          550  // rms current in mA. Multiply by 1.41 for peak current.
